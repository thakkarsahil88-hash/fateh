...
import { Flame, Scale, ChevronRight, Plus } from 'lucide-react'
...
function calcStreak(dates: string[], today: string): number {
  ...
  for (const dateStr of sorted) {
    const diff = Math.round((d.getTime() - new Date(dateStr).getTime()) / 86400000)
...
export default function HomeClient({ profile, todayPlanDay, workoutDates, latestWeight, todayDate }: Props) {
      ...
      <div>
        ...
        {todayPlanDay ? (
          ...
          <div className="bg-zinc-900 rounded-2xl p-6 text-center">
            <p className="text-zinc-400 mb-1">Rest day today</p>
